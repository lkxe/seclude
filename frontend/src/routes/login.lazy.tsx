...
import {Lock, LogIn, User, Github, Mail, GithubIcon} from 'lucide-react';
import { hello, login, listNotes, register } from '../client';
import type { HelloResponse, LoginResponse, ListNotesResponse, RegisterResponse } from '../client';
      ...
      <div className="flex items-center justify-center h-[calc(100vh-64px)] bg-gray-900">
        <div className="w-full max-w-sm p-6 bg-gray-800 rounded-lg shadow-md">
          ...
          <form onSubmit={handleLogin}>
            ...
            <span className="block text-sm text-gray-300 mb-4">Don't have an account yet? <Link to="/register" className="text-blue-500 hover:underline">Register</Link></span>
            <button
                type="submit"
